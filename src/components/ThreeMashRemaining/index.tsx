...
const ecoIcons = {
  printer: `<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M6 9V3h12v6"/><path d="M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2"/><path d="M6 14h12v7H6z"/><path d="M18 13h.01"/></svg>`,
  resin: `<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M10 2v7.5L5.2 18a2.6 2.6 0 0 0 2.3 4h9a2.6 2.6 0 0 0 2.3-4L14 9.5V2"/><path d="M8.5 2h7"/><path d="M7.5 16h9"/></svg>`,
  curing: `<svg viewBox="0 0 24 24" aria-hidden="true"><rect x="3" y="3" width="18" height="18" rx="3"/><path d="M7 7h10"/><circle cx="12" cy="14" r="4"/><path d="M9.5 14h5"/></svg>`,
  scanner: `<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M3 7V5a2 2 0 0 1 2-2h2"/><path d="M17 3h2a2 2 0 0 1 2 2v2"/><path d="M21 17v2a2 2 0 0 1-2 2h-2"/><path d="M7 21H5a2 2 0 0 1-2-2v-2"/><path d="M7 12h10"/></svg>`,
  blocks: `<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 2 3 7l9 5 9-5-9-5Z"/><path d="M3 7v10l9 5 9-5V7"/><path d="M12 12v10"/></svg>`,
  oven: `<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M8.5 14.5a3.5 3.5 0 1 0 7 0c0-3-3.5-4.2-2.4-8.5-2.8 1.8-5.6 4.2-4.6 8.5Z"/><path d="M12 22a8 8 0 0 0 8-8c0-3.9-2.4-7.2-5.8-8.6"/><path d="M4 14a8 8 0 0 0 8 8"/></svg>`,
};

const defaultSolutionHtml = `
...
export function ThreeMashRemaining(props: Props) {
  ...
  return (
    <div className="three-mash-remaining" style={themeStyle}>
      <div dangerouslySetInnerHTML={html(props.solutionHtml, defaultSolutionHtml)} />
      <div dangerouslySetInnerHTML={html(props.curingHtml, defaultCuringHtml)} />
      <div dangerouslySetInnerHTML={html(props.roiHtml, defaultRoiHtml)} />
      <div dangerouslySetInnerHTML={html(props.ecosystemHtml, defaultEcosystemHtml)} />
      <div dangerouslySetInnerHTML={html(props.trustHtml, defaultTrustHtml)} />
      <div dangerouslySetInnerHTML={html(props.faqHtml, defaultFaqHtml)} />
      <div dangerouslySetInnerHTML={html(props.finalHtml, defaultFinalHtml)} />
      <div dangerouslySetInnerHTML={html(props.footerHtml, defaultFooterHtml)} />
    </div>
  );
}

export default ThreeMashRemaining;
