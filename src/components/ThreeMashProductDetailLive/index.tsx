...
function genericProductData(product: IkasProduct, variant: IkasProductVariant | null, labels: Pick<Props, "addToCartText" | "addingToCartText" | "outOfStockText">): ProductDetailTemplateData {
  ...
  const categoryText = categoryName(firstCategory) || "Ürünler";
  ...
  return {
    ...
    hero: {
      ...
      leadHtml: summaryText(product) || "Dental klinik ve laboratuvar iş akışları için optimize edilmiş yüksek hassasiyetli üretim çözümü.",
      pills: [
