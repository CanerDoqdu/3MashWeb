...
// EN paths are written out in full ("/en/...") so they never depend on
// localizedHref() guessing an English slug.
// ---------------------------------------------------------------------------
function contactHref() {
  return tLocalized("/pages/iletisim", "/en/iletisim");
}

function resinsHref() {
  return tLocalized("/dental-3d-yazici-recineleri", "/en/dental-resins");
}

function printersHref() {
  return tLocalized("/3d-yazicilar", "/en/3d-printers");
}

function washCureHref() {
  return tLocalized("/yikama-kurleme-cihazlari", "/en/wash-and-cure-devices");
}

function scannersHref() {
  return tLocalized("/masasustu-tarayicilar", "/en/lab-scanners");
}

function whyCuringHref() {
  return `${washCureHref()}#neden-gerekli`;
}

function p16lHref() {
  return tLocalized("/mash-p16l-385nm-16k-dental-3d-yazici", "/en/mash-p16l-385nm-16k-dental-3d-printer");
}

function c1eHref() {
  return tLocalized("/mash-c1e-uv-kurleme-cihazi", "/en/mash-c1e-uv-curing-device");
}

function w1eHref() {
  return tLocalized("/mash-w1e-ultrasonik-yikama-cihazi", "/en/mash-w1e-ultrasonik-yikama-cihazi");
}

function wavelengthBlogHref() {
  return tLocalized(
...
function categoryKeyMatches(key: string, categoryKey: string) {
  // Candidate keys are normalized too, so mixed-case names ("Mash W1E") match.
  const target = normalizeCategoryKey(categoryKey);
  if (!target) return false;
  return key === target || key.startsWith(`${target} `) || key.endsWith(` ${target}`) || key.includes(` ${target} `);
}
...
export function dentalResinsCategoryData(): CategoryLandingData {
  ...
  hero: {
    titlePrefix: tLocalized("Sonucun yarısı", "Half of the result is hidden"),
    titleEmphasis: tLocalized("reçinede", "in the resin."),
    titleSuffix: tLocalized("saklı.", ""),
    descriptionHtml:
    ...
    buttons: [
      ...
      { label: tLocalized("Emin değil misiniz? Ekibe sorun", "Not sure? Ask our team"), href: contactHref(), variant: "line" },
    ],
    metrics: [
      { value: "CE", emphasis: "Class IIa", label: tLocalized("biyouyumlu CRS hattı · sertifikalı", "biocompatible CRS line · certified") },
      { value: "16", emphasis: tLocalized("reçine", "resins"), label: tLocalized("model, kron, protez, diş eti, splint, aligner, guide…", "model, crown, denture, gingiva, splint, aligner, guide…") },
      ...
      { value: tLocalized("Birlikte", "Together"), emphasis: tLocalized("kalibre", "calibrated"), label: tLocalized("cihaz parametrelerinizle eşleştirilerek teslim", "delivered matched to your device parameters") },
    ],
  },
  selector: {
    anchorId: "secici",
    ...
    number: "01",
    label: tLocalized("REÇİNE SEÇİCİ", "RESIN SELECTOR"),
    ...
    emptyMessageHtml: tLocalized("Bu kategoride ürün yok. <a href=\"/pages/iletisim\">İhtiyacınızı bize iletin →</a>", "There are no products in this category. <a href=\"/en/iletisim\">Let us know what you need →</a>"),
    products: [
      {
        title: "CRS Composite",
      ...
      },
      {
        ...
        filterId: "protez",
        tag: tLocalized("YIRTILMAZ", "TEAR-PROOF"),
        tone: "#F5DEE0",
      },
      {
      ...
      },
      {
        ...
        filterId: "orto",
        tag: tLocalized("HASSAS · ESNEK", "PRECISE · FLEXIBLE"),
        tone: "#E6F2F0",
      },
      {
        title: "CRS Guide",
  ...
  feature: {
    ...
    content: {
      ...
      titlePrefix: tLocalized("Daimi kron artık", "Permanent crowns now come"),
      titleEmphasis: tLocalized("baskıdan", "straight from the printer."),
      titleSuffix: tLocalized("çıkıyor.", ""),
      descriptionHtml:
  ...
  detail: {
    ...
    titlePrefix: tLocalized("Bütçenize göre hat,", "A line for your budget,"),
    titleEmphasis: tLocalized("kaliteye göre değil.", "not for a quality tier."),
    sideHtml:
    ...
    lineCards: [
      ...
      {
        marker: "M",
        title: tLocalized("Mash — Ekonomik hat", "Mash — Economical line"),
        descriptionHtml:
    ...
    callout: {
      ...
      titleEmphasis: tLocalized("kürleme sonucu tamamlar.", "curing completes the result."),
      descriptionHtml:
      ...
      buttons: [{ label: tLocalized("Kürlemenin önemini gör →", "See the importance of curing →"), href: whyCuringHref(), variant: "dark" }],
    },
  },
  faq: {
    number: "04",
    ...
    items: [
      ...
      },
      {
        ...
        answerHtml:
          tLocalized("Kesinlikle. <b>Yetersiz kürleme</b> kırılganlık ve monomer salınımı, <b>fazla kürleme</b> deformasyon yaratır. Doğru reçine bile yanlış kürlemeyle başarısız olur; bu yüzden her reçineyi bir kürleme protokolüyle veriyoruz. Detay için <a href=\"/yikama-kurleme-cihazlari#neden-gerekli\">kürleme bölümüne</a> bakabilirsiniz.", "Absolutely. <b>Insufficient curing</b> causes brittleness and monomer release, while <b>excessive curing</b> causes deformation. Even the right resin can fail with the wrong curing; that's why we provide every resin with a curing protocol. For details, you can check the <a href=\"/en/wash-and-cure-devices#neden-gerekli\">curing section</a>."),
      },
    ],
  },
  finalCta: {
    titlePrefix: tLocalized("İşinize uygun reçineyi", "Let's choose the right resin for your work"),
    titleEmphasis: tLocalized("birlikte seçelim.", "together."),
    descriptionHtml:
    ...
    buttons: [
      { label: tLocalized("Uzmana danış — ücretsiz", "Consult an expert — free"), href: contactHref(), variant: "lime" },
...
export function printersCategoryData(): CategoryLandingData {
  ...
  hero: {
    ...
    buttons: [
      ...
      { label: tLocalized("Bana uygun olanı öner", "Recommend the right one for me"), href: contactHref(), variant: "line" },
    ],
    metrics: [
  ...
  selector: {
    ...
    titleEmphasis: tLocalized("üç yol.", "three options."),
    sideHtml:
    ...
    products: [
      {
        ...
        specs: [
          ...
          { label: tLocalized("Kalibrasyon", "Calibration"), value: tLocalized("8 nokta dikey kilit", "8-point vertical lock") },
        ],
      },
      {
        title: "Mash CURIE M1",
        ...
        specs: [
          { label: tLocalized("Hassasiyet", "Precision"), value: tLocalized("±20 µm tekrarlanabilir", "±20 µm repeatable") },
      ...
      },
      {
        ...
        descriptionHtml: tLocalized("6K çözünürlük; <b>3mash iyileştirmeli</b> versiyonda <b>±15 µm</b> garanti. $10.000'lık cihaz kalitesine çok daha uygun fiyata.", "6K resolution; <b>±15 µm</b> guaranteed in the <b>3mash-enhanced</b> version. Quality close to a $10,000 device at a far more affordable price."),
        ...
        specs: [
          ...
          { label: tLocalized("Hassasiyet", "Precision"), value: tLocalized("±15 µm (arttırılmış)", "±15 µm (enhanced)") },
    ...
    compare: {
      columns: [
        ...
        { title: "MASH P16L", subtitle: tLocalized("En yüksek çözünürlük", "Highest resolution") },
        { title: "Mash CURIE M1", subtitle: tLocalized("Hız + yerli", "Speed + domestic") },
        { title: "Creality Halot-Sky 6K", subtitle: tLocalized("Ekonomik giriş", "Economical entry") },
      ],
      rows: [
        { label: tLocalized("Çözünürlük / Hassasiyet", "Resolution / Precision"), values: ["<b>14×19 µm</b> · 16K", tLocalized("<b>±20 µm</b> tekrarlanabilir", "<b>±20 µm</b> repeatable"), tLocalized("<b>±15 µm</b> (arttırılmış)", "<b>±15 µm</b> (enhanced)")] },
        ...
        { label: tLocalized("Gizli lisans / RFID", "Hidden license / RFID"), values: [`<span class="tmcl-yes">${tLocalized("Yok", "None")}</span>`, `<span class="tmcl-yes">${tLocalized("Yok", "None")}</span>`, `<span class="tmcl-yes">${tLocalized("Yok", "None")}</span>`] },
        { label: tLocalized("En uygun", "Best for"), values: [tLocalized("Detay & keskin marjin gereken işler", "Work requiring detail & sharp margins"), tLocalized("Yüksek hacim, hız, düşük TCO", "High volume, speed, low TCO"), tLocalized("Dijitale ekonomik giriş", "An economical entry into digital")] },
      ],
      noteHtml:
  ...
  feature: {
    ...
    label: tLocalized("ÖNE ÇIKAN", "FEATURED"),
    content: {
      eyebrow: tLocalized("MASH P16L · 385nm · 16K", "MASH P16L · 385 nm · 16K"),
  ...
  detail: {
    ...
    titlePrefix: tLocalized("İyi cihaz değil,", "Not just a good device,"),
    ...
    whyCards: [
      ...
      { number: "04", title: tLocalized("Kilitlenme yok", "No lock-in"), descriptionHtml: tLocalized("<b>Gizli lisans / RFID ücreti yok.</b> İstediğiniz marka reçineyle çalışır, bir ekosisteme mahkûm olmazsınız.", "<b>No hidden license / RFID fee.</b> Works with any resin brand you like — you're not locked into one ecosystem.") },
    ],
    callout: {
      titlePrefix: tLocalized("Yazıcı, hikâyenin", "The printer is"),
      titleEmphasis: tLocalized("üçte biri.", "only one-third of the story."),
      descriptionHtml:
      ...
      buttons: [
        { label: tLocalized("Uyumlu reçineler →", "Compatible resins →"), href: resinsHref(), variant: "dark" },
        { label: tLocalized("Kürlemenin önemi →", "The importance of curing →"), href: whyCuringHref(), variant: "line" },
      ],
    },
  },
  faq: {
  ...
  finalCta: {
    titlePrefix: tLocalized("Doğru yazıcıyı", "Let's choose the right printer"),
    titleEmphasis: tLocalized("birlikte seçelim.", "together."),
    descriptionHtml:
...
export function washCureCategoryData(): CategoryLandingData {
  ...
  announcement: {
    ...
    text: tLocalized("Yıkama ve kürleme kritik; W1E ve C1E cihazlarını birlikte kullanın.", "Washing and curing are critical; use the W1E and C1E together."),
    href: "#cihaz",
    ctaText: tLocalized("Cihaza git →", "Go to devices →"),
  },
  breadcrumb: {
    homeLabel: tLocalized("Ana sayfa", "Home"),
    homeHref: "/",
    parentLabel: tLocalized("Ürünler", "Products"),
    currentLabel: tLocalized("Yıkama Kürleme Cihazları", "Wash & Cure Devices"),
  },
  hero: {
    titlePrefix: tLocalized("Baskı bittiğinde", "When printing ends,"),
    ...
    buttons: [
      { label: tLocalized("Yıkama & kürleme cihazını incele ↓", "Browse the devices ↓"), href: "#cihaz", variant: "lime" },
      { label: tLocalized("Akışı birlikte kuralım", "Let's set up the workflow together"), href: contactHref(), variant: "line" },
    ],
    metrics: [
      { value: "3", emphasis: tLocalized("cihaz", "devices"), label: tLocalized("yıkama ve kürleme adımları", "washing and curing steps") },
  ...
  selector: {
    ...
    number: "01",
    label: tLocalized("CİHAZLAR", "DEVICES"),
    titlePrefix: tLocalized("Baskı sonrası için", "After printing,"),
    ...
    products: [
      ...
      },
      {
        ...
        specs: [
          ...
          { label: tLocalized("Spektrum", "Spectrum"), value: "360-530 nm" },
  ...
  feature: {
    ...
    content: {
      ...
      titlePrefix: tLocalized("Yıkama ve kürleme", "Washing and curing are"),
      titleEmphasis: tLocalized("ayrı ayrı kontrol edilir.", "controlled separately."),
      descriptionHtml:
      ...
      specs: [
        ...
        { label: tLocalized("C1E spektrum", "C1E spectrum"), value: "360-530 nm" },
      ],
    },
  },
  detail: {
    ...
    callout: {
      ...
      buttons: [
        { label: tLocalized("Uyumlu reçineleri gör →", "See compatible resins →"), href: resinsHref(), variant: "dark" },
        { label: tLocalized("3D yazıcılara git →", "Go to 3D printers →"), href: printersHref(), variant: "line" },
      ],
    },
  },
  faq: {
    ...
    items: [
      {
        question: tLocalized("Yıkama kürleme cihazı neden gerekli?", "Why is a wash & cure device necessary?"),
        answerHtml:
      ...
      {
        question: tLocalized("Bu kategoride hangi ürün var?", "Which products are in this category?"),
        answerHtml:
  ...
  finalCta: {
    titlePrefix: tLocalized("Baskı sonrası akışı", "Let's build your post-print workflow"),
    titleEmphasis: tLocalized("birlikte kuralım.", "together."),
    descriptionHtml:
...
export function washingCategoryData(): CategoryLandingData {
  ...
  hero: {
    ...
    titleEmphasis: tLocalized("kusursuz yüzey,", "a flawless surface"),
    ...
    buttons: [
      ...
      { label: tLocalized("İş akışına danış", "Consult the workflow"), href: contactHref(), variant: "line" },
    ],
    metrics: [
      { value: tLocalized("Ultrasonik", "Ultrasonic"), emphasis: tLocalized("yıkama", "washing"), label: tLocalized("mikro boşluklarda derinlemesine temizlik", "deep cleaning in micro gaps") },
      { value: "16.453", emphasis: "TRY", label: tLocalized("W1E başlangıç fiyatı", "W1E starting price") },
      { value: tLocalized("Hassas", "Precise"), emphasis: tLocalized("arındırma", "cleaning"), label: tLocalized("parça geometrisine zarar vermez", "does not damage the part geometry") },
      { value: tLocalized("Kürleme", "Ready for"), emphasis: tLocalized("öncesi", "curing"), label: tLocalized("homojen post-curing için hazır yüzey", "ready surface for homogeneous post-curing") },
    ],
  },
  selector: {
    anchorId: "cihaz",
    ...
    titlePrefix: tLocalized("Baskı sonrası için", "For post-print cleaning,"),
    ...
    compare: {
      columns: [
        { title: tLocalized("Özellik", "Feature") },
        { title: "Mash W1E", subtitle: tLocalized("Ultrasonik Yıkama", "Ultrasonic Washing") },
        { title: "Creality UW02", subtitle: tLocalized("Kombine Yıkama", "Combined Washing") },
      ],
      rows: [
        { label: tLocalized("Temizleme Teknolojisi", "Cleaning Technology"), values: [tLocalized("<b>Ultrasonik kavitasyon</b>", "<b>Ultrasonic cavitation</b>"), tLocalized("Pervaneli girdap akışı", "Propeller vortex flow")] },
        ...
        { label: tLocalized("Yüzey Bütünlüğü", "Surface Integrity"), values: [tLocalized("Hassas parçalara zarar vermez", "Does not damage delicate parts"), tLocalized("Girdap hareketli", "Vortex agitation")] },
  ...
  feature: {
    ...
    content: {
      ...
      titleEmphasis: tLocalized("mikron seviyesinde temizlik.", "micron-level cleaning."),
      descriptionHtml:
      ...
      specs: [
        { label: tLocalized("İşlem", "Process"), value: tLocalized("Ultrasonik yıkama", "Ultrasonic washing") },
        { label: tLocalized("Akış", "Workflow"), value: tLocalized("Baskı sonrası temizlik", "Post-print cleaning") },
        { label: tLocalized("Temizlik", "Cleaning"), value: tLocalized("Mikron hassasiyetinde", "Micron-level precision") },
  ...
  detail: {
    ...
    callout: {
      ...
      buttons: [
        { label: tLocalized("Kürleme cihazlarını gör →", "See curing devices →"), href: "/kurleme-cihazlari", variant: "dark" },
      ],
    },
  },
  faq: {
  ...
  finalCta: {
    titlePrefix: tLocalized("Laboratuvarınız için doğru yıkama akışını", "Let's build the right washing workflow for your laboratory"),
    titleEmphasis: tLocalized("birlikte kuralım.", "together."),
    descriptionHtml:
...
export function curingCategoryData(): CategoryLandingData {
  ...
  kind: "curing",
  announcement: {
    highlight: tLocalized("⚡ Mekanik dayanım ve biyouyumluluğu tamamlayın", "⚡ Complete mechanical strength and biocompatibility"),
  ...
  hero: {
    titlePrefix: tLocalized("Reçinenin gerçek gücü", "The resin's true strength emerges"),
    titleEmphasis: tLocalized("doğru kürlemeyle", "with correct curing."),
    titleSuffix: tLocalized("ortaya çıkar.", ""),
    descriptionHtml:
    ...
    buttons: [
      ...
      { label: tLocalized("Kürleme protokolü danış", "Ask about the curing protocol"), href: contactHref(), variant: "line" },
    ],
    metrics: [
  ...
  selector: {
    ...
    compare: {
      columns: [
        { title: tLocalized("Özellik", "Feature") },
        { title: "Mash C1E", subtitle: tLocalized("Profesyonel Akıllı Kürleme", "Professional Smart Curing") },
        { title: "Creality UW02", subtitle: tLocalized("Kombine Cihaz", "Combined Device") },
      ],
      rows: [
        ...
        { label: tLocalized("Biyouyumluluk Uyumu", "Biocompatibility Compatibility"), values: [tLocalized("<b>CE Class IIa protokollerine tam uyum</b>", "<b>Full compliance with CE Class IIa protocols</b>"), tLocalized("Standart", "Standard")] },
  ...
  feature: {
    ...
    content: {
      ...
      titlePrefix: tLocalized("24 LED ile", "Shadow-free, homogeneous"),
      titleEmphasis: tLocalized("gölgesiz ve homojen", "polymerization"),
      titleSuffix: tLocalized("polimerizasyon.", "with 24 LEDs."),
      descriptionHtml:
  ...
  detail: {
    ...
    callout: {
      ...
      buttons: [
        { label: tLocalized("Dental reçineleri incele →", "Explore dental resins →"), href: resinsHref(), variant: "dark" },
      ],
    },
  },
  faq: {
  ...
  finalCta: {
    titlePrefix: tLocalized("Kürleme sürecinizi", "Let's standardize your"),
    titleEmphasis: tLocalized("standarda bağlayalım.", "curing process."),
    descriptionHtml:
...
export function zirconBlocksCategoryData(): CategoryLandingData {
  ...
  kind: "zircon",
  announcement: {
    highlight: tLocalized("⚡ Zirkon seçimini vaka belirler", "⚡ The case determines the zirconia selection"),
  ...
  hero: {
    ...
    titleEmphasis: tLocalized("vakanın içinde", "is chosen by the case."),
    titleSuffix: tLocalized("seçilir.", ""),
    descriptionHtml:
    ...
    buttons: [
      ...
      { label: tLocalized("Vaka uyumunu sor", "Ask about case fit"), href: contactHref(), variant: "line" },
    ],
    metrics: [
      { value: "3", emphasis: tLocalized("ürün", "products"), label: tLocalized("farklı estetik ve dayanım seçenekleri", "different aesthetic and strength options") },
      { value: "850", emphasis: "MPa", label: tLocalized("ST Multilayer estetik zirkon dayanımı", "ST Multilayer aesthetic zirconia strength") },
      { value: "1250", emphasis: "MPa", label: tLocalized("HT+ ve HT+ Multilayer yüksek dayanım sınıfı", "HT+ and HT+ Multilayer high-strength class") },
  ...
  selector: {
    ...
    products: [
      {
        title: tLocalized("ArgenZ HT+ Zirkon Blok", "ArgenZ HT+ Zirconia Block"),
        descriptionHtml:
        ...
        imageAlt: tLocalized("ArgenZ HT+ Zirkon Blok", "ArgenZ HT+ Zirconia Block"),
        tag: "HT+",
        status: "",
        hot: true,
        tone: "#F1F1EC",
      ...
      {
        title: tLocalized("ArgenZ ST Multilayer Zirkon Blok", "ArgenZ ST Multilayer Zirconia Block"),
        descriptionHtml:
        ...
        imageAlt: tLocalized("ArgenZ ST Multilayer Zirkon Blok", "ArgenZ ST Multilayer Zirconia Block"),
        tag: "ST MULTILAYER",
        status: "",
        tone: "#F1F1EC",
        specs: [
      ...
      {
        title: tLocalized("ArgenZ HT+ Multilayer Zirkon Blok", "ArgenZ HT+ Multilayer Zirconia Block"),
        descriptionHtml:
        ...
        imageAlt: tLocalized("ArgenZ HT+ Multilayer Zirkon Blok", "ArgenZ HT+ Multilayer Zirconia Block"),
        tag: "HT+ MULTILAYER",
        status: "",
        tone: "#F1F1EC",
        specs: [
    ...
    compare: {
      columns: [
        ...
        { title: "HT+", subtitle: tLocalized("Dayanım dengesi", "Strength balance") },
        { title: "ST Multilayer", subtitle: tLocalized("Estetik geçirgenlik", "Aesthetic translucency") },
        { title: "HT+ Multilayer", subtitle: tLocalized("Gradient + güç", "Gradient + strength") },
      ],
      rows: [
  ...
  detail: {
    ...
    titlePrefix: tLocalized("Zirkon blok,", "The zirconia block"),
    ...
    callout: {
      ...
      buttons: [
        { label: tLocalized("Dental fırınlara git →", "Go to dental furnaces →"), href: tLocalized("/dental-firinlar", "/en/dental-furnaces"), variant: "dark" },
        { label: tLocalized("Teknik destek al →", "Get technical support →"), href: contactHref(), variant: "line" },
      ],
    },
  },
  faq: {
  ...
  finalCta: {
    titlePrefix: tLocalized("Doğru zirkonu", "Let's choose the right zirconia"),
    titleEmphasis: tLocalized("birlikte seçelim.", "together."),
    descriptionHtml:
...
export function dentalFurnacesCategoryData(): CategoryLandingData {
  ...
  hero: {
    titlePrefix: tLocalized("Restorasyon kalitesi,", "Restoration quality is completed"),
    titleEmphasis: tLocalized("kontrollü ısıyla", "with controlled heat."),
    titleSuffix: tLocalized("tamamlanır.", ""),
    descriptionHtml:
      tLocalized("Zirkon sinterleme, press seramik ve porselen pişiriminde sonuç; fırın sıcaklığı, çevrim kontrolü ve laboratuvar akışının birlikte kurulmasıyla stabil hale gelir. Naberthem hattı, hızlı sinterleme ihtiyacından vakumlu porselen pişirimine kadar dental üretimin kritik ısı adımlarını kapsar.", "The outcome of zirconia sintering, press ceramic, and porcelain firing becomes stable when furnace temperature, cycle control, and lab workflow are set up together. The Naberthem line covers the critical heat steps of dental production, from fast sintering needs to vacuum porcelain firing."),
    buttons: [
      { label: tLocalized("Fırınları incele ↓", "Explore furnaces ↓"), href: "#firinlar", variant: "lime" },
      { label: tLocalized("Akışı birlikte planlayalım", "Let's plan the workflow together"), href: contactHref(), variant: "line" },
    ],
    metrics: [
      { value: "4", emphasis: tLocalized("ürün", "products"), label: tLocalized("sinterleme ve porselen pişirim seçenekleri", "sintering and porcelain firing options") },
      ...
      { value: "Press", emphasis: tLocalized("/ Porselen", "/ Porcelain"), label: tLocalized("VL 01/12 LB hattında iki farklı laboratuvar işi", "Two different laboratory jobs on the VL 01/12 LB line") },
    ],
  },
  selector: {
    anchorId: "firinlar",
    ...
    products: [
      {
        ...
        tag: tLocalized("SİNTERLEME", "SINTERING"),
        status: tLocalized("Teklif alın", "Get a quote"),
        hot: true,
        tone: "#F1F1EC",
        specs: [
          { label: tLocalized("Kategori sırası", "Category order"), value: "1" },
          { label: tLocalized("Maksimum", "Maximum"), value: "1650 °C" },
      ...
      },
      {
        ...
        specs: [
          { label: tLocalized("Kategori sırası", "Category order"), value: "2" },
          { label: tLocalized("Maksimum", "Maximum"), value: "1600 °C" },
      ...
      },
      {
        ...
        specs: [
          { label: tLocalized("Kategori sırası", "Category order"), value: "3" },
          { label: tLocalized("Tip", "Type"), value: tLocalized("Pres fırını", "Press furnace") },
          { label: tLocalized("Yapı", "Structure"), value: tLocalized("Kaldırma tabla", "Lift table") },
        ],
      },
      {
        ...
        specs: [
          ...
          { label: tLocalized("Atmosfer", "Atmosphere"), value: tLocalized("Normal / vakum", "Normal / vacuum") },
    ...
    compare: {
      columns: [
        { title: tLocalized("Akış", "Workflow") },
        { title: "LHT 02/17", subtitle: tLocalized("yüksek hacim", "high volume") },
        { title: "Turbo Fire", subtitle: tLocalized("hızlı sinterleme", "fast sintering") },
        { title: "VL 01/12", subtitle: tLocalized("press / porselen", "press / porcelain") },
      ],
      rows: [
  ...
  feature: {
    ...
    content: {
      ...
      ctaText: tLocalized("Ürün detayına git →", "Go to product details →"),
      specs: [
        { label: tLocalized("Maksimum sıcaklık", "Maximum temperature"), value: "1650 °C" },
  ...
  detail: {
    ...
    whyCards: [
      ...
      { number: "03", title: "Press", descriptionHtml: tLocalized("Press seramik akışında kaldırma tabla ve kontrollü çevrim, tekrarlanabilir presleme sonucunu destekler.", "In the press ceramic workflow, the lift table and controlled cycle support a repeatable pressing result.") },
    ...
    callout: {
      ...
      buttons: [
        { label: tLocalized("Zirkon bloklara git →", "Go to zirconia blocks →"), href: tLocalized("/zirkon-bloklar", "/en/zircon-blocks"), variant: "dark" },
        { label: tLocalized("Teknik destek al →", "Get technical support →"), href: contactHref(), variant: "line" },
      ],
    },
  },
  ...
  finalCta: {
    titlePrefix: tLocalized("Laboratuvarınıza uygun fırını", "Let's choose the right furnace for your laboratory"),
    titleEmphasis: tLocalized("birlikte seçelim.", "together."),
    descriptionHtml:
...
export function desktopScannersCategoryData(): CategoryLandingData {
  ...
  hero: {
    titlePrefix: tLocalized("Dijital üretim,", "Digital production begins"),
    titleEmphasis: tLocalized("doğru taramayla", "with correct scanning."),
    titleSuffix: tLocalized("başlar.", ""),
    descriptionHtml:
    ...
    buttons: [
      ...
      { label: tLocalized("Laboratuvarı birlikte eşleyelim", "Let's match the laboratory together"), href: contactHref(), variant: "line" },
    ],
    metrics: [
      { value: "3", emphasis: tLocalized("ürün", "products"), label: tLocalized("E2, E3 ve E4 tarayıcı seçenekleri", "E2, E3, and E4 scanner options") },
      { value: "4", emphasis: "μm", label: tLocalized("3Shape E4 hassasiyet bilgisi", "3Shape E4 precision") },
      { value: "9", emphasis: tLocalized("sn", "sec"), label: tLocalized("3Shape E4 tam çene tarama hızı", "3Shape E4 full-arch scanning speed") },
      { value: "3Shape", emphasis: tLocalized("E serisi", "E series"), label: tLocalized("dental laboratuvar CAD/CAM başlangıcı", "dental laboratory CAD/CAM starting point") },
    ],
  },
  selector: {
    ...
    products: [
      ...
      },
      {
        ...
        specs: [
          ...
          { label: tLocalized("Tam çene", "Full arch"), value: tLocalized("9 sn", "9 sec") },
        ],
      },
    ],
    compare: {
      columns: [
        { title: tLocalized("Seçim", "Selection") },
        { title: "E2", subtitle: tLocalized("doku taraması", "tissue scanning") },
        { title: "E3", subtitle: "implant bar" },
        { title: "E4", subtitle: tLocalized("hız + hassasiyet", "speed + precision") },
      ],
      rows: [
  ...
  feature: {
    ...
    content: {
      ...
      specs: [
        { label: tLocalized("Hassasiyet", "Accuracy"), value: "4 μm" },
        { label: tLocalized("Tam çene", "Full arch"), value: tLocalized("9 sn", "9 sec") },
        { label: tLocalized("Kamera", "Cameras"), value: "4" },
        { label: tLocalized("Kategori sırası", "Category order"), value: "3" },
      ],
    },
  },
  ...
  finalCta: {
    titlePrefix: tLocalized("Laboratuvarınıza uygun tarayıcıyı", "Let's choose the right scanner for your laboratory"),
    titleEmphasis: tLocalized("birlikte seçelim.", "together."),
    descriptionHtml:
...
export function printerSparePartsCategoryData(): CategoryLandingData {
  ...
  kind: "spares",
  announcement: {
    highlight: tLocalized("⚡ Doğru yedek parça cihaz uyumuyla seçilir", "⚡ Choose the right spare part by device compatibility"),
  ...
  hero: {
    titlePrefix: tLocalized("Üretim sürekliliği,", "Production continuity is protected"),
    titleEmphasis: tLocalized("doğru parçayla", "with the right part."),
    titleSuffix: tLocalized("korunur.", ""),
    descriptionHtml:
    ...
    buttons: [
      ...
      { label: tLocalized("Uyumluluğu kontrol ettir", "Get compatibility checked"), href: contactHref(), variant: "line" },
    ],
    metrics: [
      { value: "8", emphasis: tLocalized("ürün", "products"), label: tLocalized("yazıcı bakım ve yedek parça seçenekleri", "printer maintenance and spare part options") },
      { value: "16K", emphasis: "LCD", label: tLocalized("MASH P16L monokrom ekran yedek parçası", "MASH P16L monochrome screen replacement part") },
      { value: "800", emphasis: "ml", label: tLocalized("MASH P16L reçine tankı kapasitesi", "MASH P16L resin tank capacity") },
      { value: "6K", emphasis: "Mono", label: tLocalized("Creality Halot Sky LCD ekran kiti", "Creality Halot Sky LCD display kit") },
    ],
  },
  selector: {
    ...
    titlePrefix: tLocalized("Elektronik, tabla,", "Electronics, build plate,"),
    ...
    products: [
      {
        ...
        tag: tLocalized("KONTROL", "CONTROL"),
        status: "12.913 TRY",
        hot: true,
        tone: "#F1F1EC",
        specs: [
          { label: tLocalized("Sıra", "Order"), value: "1" },
          { label: tLocalized("Cihaz", "Device"), value: "MASH P16L" },
          { label: tLocalized("Tip", "Type"), value: tLocalized("Ana kart", "Mainboard") },
        ],
      },
      {
        ...
        specs: [
          ...
          { label: tLocalized("Boyut", "Size"), value: tLocalized("9.6 inç", "9.6 inches") },
          { label: tLocalized("Işık", "Light"), value: "385 nm" },
        ],
      },
      {
        ...
        specs: [
          ...
          { label: tLocalized("Uyum", "Compatibility"), value: "MASH P16L" },
        ],
      },
      {
        ...
        specs: [
          ...
          { label: tLocalized("Ölçü", "Dimensions"), value: "211x118 mm" },
          { label: tLocalized("Uyum", "Compatibility"), value: "MASH P16L" },
        ],
      },
      {
        ...
        specs: [
          ...
          { label: tLocalized("Kapasite", "Capacity"), value: "800 ml" },
      ...
      },
      {
        ...
        specs: [
          ...
          { label: tLocalized("Uyum", "Compatibility"), value: "LCD / DLP" },
          { label: tLocalized("Tip", "Type"), value: tLocalized("Sarf film", "Consumable film") },
        ],
      },
      {
        title: tLocalized("Piocreat C01 LCD Ekran Kiti", "Piocreat C01 LCD Screen Kit"),
        descriptionHtml:
        ...
        imageAlt: tLocalized("Piocreat C01 LCD Ekran Kiti", "Piocreat C01 LCD Screen Kit"),
        tag: "C01 LCD",
        status: "20.718 TRY",
        tone: "#F1F1EC",
        specs: [
          { label: tLocalized("Sıra", "Order"), value: "7" },
          { label: tLocalized("Cihaz", "Device"), value: "Piocreat C01" },
          { label: tLocalized("Tip", "Type"), value: "LCD kit" },
        ],
      },
      {
    ...
    compare: {
      columns: [
        ...
        { title: tLocalized("Elektronik", "Electronics") },
        { title: tLocalized("Baskı yüzeyi", "Print surface") },
        { title: tLocalized("Tank / film", "Tank / film") },
      ],
      rows: [
        { label: tLocalized("Ürünler", "Products"), values: [tLocalized("Ana kart, 16K LCD, C01 LCD, Halot Sky LCD", "Mainboard, 16K LCD, C01 LCD, Halot Sky LCD"), tLocalized("Küçük tabla, büyük tabla", "Small plate, large plate"), tLocalized("P16L reçine tankı, ACF/FEP film", "P16L resin tank, ACF/FEP film")] },
  ...
  feature: {
    ...
    content: {
      ...
      titlePrefix: tLocalized("Mikron detay", "Micron-level detail begins"),
  ...
  detail: {
    ...
    titleEmphasis: tLocalized("kalibrasyonla biter.", "ends with calibration."),
    sideHtml:
    ...
    callout: {
      ...
      buttons: [
        { label: tLocalized("3D yazıcılara git →", "Go to 3D printers →"), href: printersHref(), variant: "dark" },
        { label: tLocalized("Teknik destek al →", "Get technical support →"), href: contactHref(), variant: "line" },
      ],
    },
  },
  ...
  finalCta: {
    titlePrefix: tLocalized("Doğru yedek parçayı", "Let's identify the right spare part"),
    titleEmphasis: tLocalized("birlikte netleştirelim.", "together."),
    descriptionHtml:
...
export function systemsCategoryData(): CategoryLandingData {
  ...
  kind: "systems",
  announcement: {
    highlight: tLocalized("⚡ Sistem ürünleri birlikte düşünülür", "⚡ System products work together"),
    text: tLocalized("Trasformer Comp Flow ve Light Glass akışını tam çene kompozit restorasyon ihtiyacına göre karşılaştırın.", "Compare the Comp Flow and Light Glass workflow for your full-arch composite case."),
    href: "#sistemler",
  ...
  hero: {
    titlePrefix: tLocalized("Tam çene kompozitte", "In full-arch composite work,"),
    titleEmphasis: tLocalized("sistem birlikte", "the system works together."),
    titleSuffix: tLocalized("çalışır.", ""),
    descriptionHtml:
    ...
    metrics: [
      { value: "2", emphasis: tLocalized("ürün", "products"), label: tLocalized("Comp Flow ve Light Glass sistemleri", "Comp Flow and Light Glass systems") },
      { value: tLocalized("Tam", "Full"), emphasis: tLocalized("çene", "arch"), label: tLocalized("kompozit restorasyon akışı", "composite restoration workflow") },
      { value: "CRS", emphasis: "Trasformer", label: tLocalized("sistem ve materyal birlikte konumlanır", "system and material positioned together") },
  ...
  selector: {
    ...
    products: [
      ...
      {
        title: tLocalized("Trasformer Light Glass Mufla Sistemi", "Trasformer Light Glass Muffle System"),
        descriptionHtml:
        ...
        imageAlt: tLocalized("Trasformer Light Glass Mufla Sistemi", "Trasformer Light Glass Muffle System"),
        tag: "LIGHT GLASS",
        status: "14.654 TRY",
        hot: true,
        tone: "#F1F1EC",
        specs: [
          { label: tLocalized("Sıra", "Order"), value: "2" },
          { label: tLocalized("Tip", "Type"), value: tLocalized("Mufla sistemi", "Muffle system") },
    ...
    compare: {
      ...
      rows: [
        ...
        { label: tLocalized("Hedef", "Aim"), values: [tLocalized("Kompozit uygulama", "Composite application"), tLocalized("Işık geçirgenliği ve stabilite", "Light transmittance and stability"), tLocalized("Doğruluk, vaka planı ve restorasyon kontrolü", "Accuracy, case plan, and restoration control")] },
  ...
  feature: {
    ...
    content: {
      ...
      specs: [
        ...
        { label: tLocalized("Materyal", "Material"), value: tLocalized("Kompozit", "Composite") },
        { label: tLocalized("Kategori sırası", "Category order"), value: "2" },
      ],
    },
  },
  detail: {
    ...
    titlePrefix: tLocalized("Sistem ürünü,", "A system product"),
    ...
    whyCards: [
      { number: "01", title: tLocalized("Materyal", "Material"), descriptionHtml: tLocalized("Comp Flow, sistem içindeki kompozit uygulama adımıdır; renk ve vaka planıyla seçilir.", "Comp Flow is the composite application step within the system; it is selected based on shade and case plan.") },
    ...
    callout: {
      ...
      buttons: [
        { label: tLocalized("Teknik destek al →", "Get technical support →"), href: contactHref(), variant: "dark" },
        { label: tLocalized("Tarayıcılara git →", "Go to scanners →"), href: scannersHref(), variant: "line" },
      ],
    },
  },
  faq: {
    ...
    items: [
      ...
      { question: tLocalized("Bu ürünler birlikte mi düşünülmeli?", "Should these products be considered together?"), answerHtml: tLocalized("Evet. Comp Flow materyal, Light Glass sistem adımı olarak aynı restorasyon akışında değerlendirilir.", "Yes. Comp Flow (the material) and Light Glass (the system step) are evaluated within the same restoration workflow.") },
  ...
  finalCta: {
    titlePrefix: tLocalized("Trasformer akışını", "Let's plan the Trasformer workflow"),
    titleEmphasis: tLocalized("birlikte planlayalım.", "together."),
    descriptionHtml:
...
export function titaniumDiscsCategoryData(): CategoryLandingData {
  ...
  hero: {
    ...
    buttons: [
      ...
      { label: tLocalized("Freze uyumunu sor", "Ask about milling compatibility"), href: contactHref(), variant: "line" },
    ],
    metrics: [
  ...
  selector: {
    ...
    products: [
      {
        ...
        specs: [
          { label: tLocalized("Kategori sırası", "Category order"), value: "1" },
          { label: tLocalized("Çap", "Diameter"), value: "Ø98.5 mm" },
    ...
    compare: {
      columns: [
        ...
        { title: tLocalized("Materyal", "Material") },
        { title: tLocalized("Freze", "Milling") },
        { title: tLocalized("Endikasyon", "Indication") },
      ],
      rows: [
        { label: tLocalized("Bu ürün", "This product"), values: [tLocalized("Titanyum Grade 5 ELI", "Titanium Grade 5 ELI"), tLocalized("Ø98.5 mm CAD/CAM disk formu", "Ø98.5 mm CAD/CAM disc form"), tLocalized("İmplant üstü restorasyonlar", "Implant-supported restorations")] },
        ...
        { label: tLocalized("Satın alma öncesi", "Before purchase"), values: [tLocalized("Materyal sınıfı", "Material class"), tLocalized("Boyut / holder uyumu", "Size / holder compatibility"), tLocalized("Restorasyon ve CAM stratejisi", "Restoration and CAM strategy")] },
      ],
      noteHtml:
  ...
  feature: {
    ...
    label: tLocalized("ÖNE ÇIKAN", "FEATURED"),
    content: {
      eyebrow: tLocalized("MESA · GRADE 5 ELI · Ø98.5 MM", "MESA · GRADE 5 ELI · Ø98.5 MM"),
      titlePrefix: tLocalized("CAD/CAM frezeleme için", "For CAD/CAM milling,"),
      titleEmphasis: tLocalized("titanyum disk.", "a titanium disc."),
      descriptionHtml:
      ...
      ctaText: tLocalized("Ürün detayına git →", "Go to product details →"),
      specs: [
        { label: tLocalized("Materyal", "Material"), value: "Grade 5 ELI" },
        { label: tLocalized("Çap", "Diameter"), value: "Ø98.5 mm" },
        { label: tLocalized("Uygulama", "Application"), value: tLocalized("İmplant üstü", "Implant-supported") },
        { label: tLocalized("Uyum", "Compatibility"), value: "CAD/CAM" },
      ],
    },
  },
  detail: {
    number: "03",
    label: tLocalized("SEÇİM MANTIĞI", "SELECTION LOGIC"),
    titlePrefix: tLocalized("Titanyum disk,", "Titanium disc selection"),
    titleEmphasis: tLocalized("CAM akışıyla", "starts with the CAM workflow."),
    titleSuffix: tLocalized("seçilir.", ""),
    sideHtml:
    ...
    whyCards: [
      ...
      { number: "04", title: tLocalized("Vaka uyumu", "Case fit"), descriptionHtml: tLocalized("İmplant üstü restorasyonlarda materyal ve tasarım hedefi birlikte doğrulanmalıdır.", "Material and design goals should be validated together for implant-supported restorations.") },
    ],
    callout: {
  ...
  finalCta: {
    titlePrefix: tLocalized("Titanyum disk uyumunu", "Let's check titanium disc compatibility"),
    titleEmphasis: tLocalized("birlikte kontrol edelim.", "together."),
    descriptionHtml:
...
export function categoryLandingDataFromKey(value: string | undefined): CategoryLandingData | null {
  ...
  // Candidate keys list both the Turkish and English variants, so routing works
  // the same whichever locale the route key comes from. categoryKeyMatches()
  // normalizes candidates, so casing/diacritics here do not matter.
  const dentalKeys = [
